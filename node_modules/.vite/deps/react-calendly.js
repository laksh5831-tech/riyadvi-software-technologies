...
//#region node_modules/react-calendly/dist/index.es.js
...
function sanitizePageSettingsProps(props) {
	if (props === null || props === void 0 ? void 0 : props.primaryColor) props.primaryColor = sanitizeColorString(props.primaryColor);
	if (props === null || props === void 0 ? void 0 : props.textColor) props.textColor = sanitizeColorString(props.textColor);
	if (props === null || props === void 0 ? void 0 : props.backgroundColor) props.backgroundColor = sanitizeColorString(props.backgroundColor);
	return props;
}
var CalendlyEvent;
...
var LoadingSpinner = function(_super) {
	...
	LoadingSpinner.prototype.render = function() {
		return import_react.createElement("div", { className: "calendly-spinner" }, import_react.createElement("div", { className: "calendly-bounce1" }), import_react.createElement("div", { className: "calendly-bounce2" }), import_react.createElement("div", { className: "calendly-bounce3" }));
	};
...
var InlineWidget = function(_super) {
	...
	InlineWidget.prototype.render = function() {
		...
		}, this.state.isLoading && import_react.createElement(LoadingSpinner$1, null), import_react.createElement("iframe", {
			width: "100%",
			height: "100%",
			frameBorder: "0",
...
var ModalContent = function(_super) {
	...
	ModalContent.prototype.render = function() {
		...
		var LoadingSpinner$1 = this.props.LoadingSpinner || LoadingSpinner;
		return import_react.createElement(import_react.Fragment, null, this.state.isLoading && import_react.createElement(LoadingSpinner$1, null), import_react.createElement("iframe", {
			width: "100%",
			height: "100%",
			frameBorder: "0",
			title: this.props.iframeTitle || "Calendly Scheduling Page",
...
var Modal = (function(props) {
	...
	if (!props.rootElement) throw new Error("[react-calendly]: PopupModal rootElement property cannot be undefined");
	return import_react_dom.createPortal(import_react.createElement("div", { className: "calendly-overlay" }, import_react.createElement("div", {
		onClick: props.onModalClose,
		className: "calendly-close-overlay"
	}), import_react.createElement("div", { className: "calendly-popup" }, import_react.createElement("div", { className: "calendly-popup-content" }, import_react.createElement(ModalContent, __assign({}, props)))), import_react.createElement("button", {
...
var PopupButton = function(_super) {
	...
	PopupButton.prototype.render = function() {
		return import_react.createElement(import_react.Fragment, null, import_react.createElement("button", {
			onClick: this.onClick,
			style: this.props.styles || {},
			className: this.props.className || ""
		}, this.props.text), import_react.createElement(Modal, __assign({}, this.props, {
...
var PopupWidget = function(_super) {
	...
	PopupWidget.prototype.render = function() {
		...
		}, this.props.text || "Schedule time with me", this.props.branding && import_react.createElement("span", null, "powered by Calendly")), import_react.createElement(Modal, __assign({}, this.props, {
			open: this.state.isOpen,
			onModalClose: this.onClose,
			rootElement: this.props.rootElement
		})));
...
function useCalendlyEventListener(eventHandlers) {
	...
	import_react.useEffect(function() {
		var onMessage = function(e) {
			...
			if (eventName === CalendlyEvent.DATE_AND_TIME_SELECTED) onDateAndTimeSelected && onDateAndTimeSelected(e);
			else if (eventName === CalendlyEvent.EVENT_SCHEDULED) onEventScheduled && onEventScheduled(e);
			else if (eventName === CalendlyEvent.EVENT_TYPE_VIEWED) onEventTypeViewed && onEventTypeViewed(e);
			else if (eventName === CalendlyEvent.PROFILE_PAGE_VIEWED) onProfilePageViewed && onProfilePageViewed(e);
			else if (eventName === CalendlyEvent.PAGE_HEIGHT) onPageHeightResize && onPageHeightResize(e);
		};
